...
- ci: adds `check-pull-request` workflow that verifies if a pull request meets the repository standards.
- ci: adds `check-release` workflow that posts release information on pull requests labeled with `release/*` labels.
